        ...
        if (auth()->user()->hasRole('Admin'))
        {
            return $table
                ->columns([
                    ...
                    Tables\Columns\TextColumn::make('start_date')->label('Start Date')->searchable()->sortable()->date('d/m/y'),
                    Tables\Columns\TextColumn::make('end_date')->label('End Date')->searchable()->sortable()->date('d/m/y'),
                    Tables\Columns\TextColumn::make('created_at')->label('Created at')->searchable()->sortable()->date('d/m/y H:i'),
